...
func (s *Service) Create(w http.ResponseWriter, r *http.Request) {
	...
	if body.Name == "" { body.Name = "My group" }
...
type joinReq struct{ Code string `json:"code"` }
...
func (s *Service) Join(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil || body.Code == "" {
		response.BadRequest(w, "code required"); return
	}
	var gid string
	err := s.pool.QueryRow(r.Context(),
	...
	if err != nil { response.NotFound(w, "invite code invalid or expired"); return }
...
func (s *Service) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil { response.NotFound(w, "group not found"); return }
	...
	if !isMember { response.Forbidden(w, "not a member of this group"); return }
